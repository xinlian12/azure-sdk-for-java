...
import com.azure.cosmos.models.{CosmosItemIdentity, CosmosParameterizedQuery, CosmosQueryRequestOptions, PartitionKeyDefinition}
...
private case class ItemsPartitionReaderWithReadManyFilter (
