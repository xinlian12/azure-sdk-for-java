...
public class FaultInjectionServerErrorRuleTests {
//
...
//                .configureFaultInjectionRules(container, Arrays.asList(serverErrorRuleLocalRegion, serverErrorRuleRemoteRegion))
//                .block();
//
//            assertThat(
