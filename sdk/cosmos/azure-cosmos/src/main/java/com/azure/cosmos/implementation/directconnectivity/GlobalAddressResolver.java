...
public class GlobalAddressResolver implements AddressResolverExtension {
    ...
    private static Logger logger = LoggerFactory.getLogger(GlobalAddressResolver.class);
            ...
            this.addressCacheByEndpoint.computeIfPresent(addressResolverURI, (ignored, endpointCache) -> {
                ...
                for (RntbdAddressCacheToken token : tokens) {
                    ...
                    if (partitionKeyRangeIdentity != null) {
                        logger.info("Remove address from cache: " + request.getActivityId() + ":" + tokens.size() + ": " + token.getRemoteAddress() + ":" + partitionKeyRangeIdentity);
