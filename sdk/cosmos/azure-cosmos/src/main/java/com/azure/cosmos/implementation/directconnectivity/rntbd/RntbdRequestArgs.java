...
public final class RntbdRequestArgs {
    ...
    public RntbdRequestArgs(final RxDocumentServiceRequest serviceRequest, final Uri addressUri) {
        ...
        this.origin = addressUri.getURI().getScheme() + "://" + addressUri.getURI().getAuthority();
        this.physicalAddressUri = addressUri;
