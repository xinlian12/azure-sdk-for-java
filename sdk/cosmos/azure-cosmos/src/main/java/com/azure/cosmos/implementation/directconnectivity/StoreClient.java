...
public class StoreClient implements IStoreClient {
    ...
    public void enableThroughputBudgetControl(ThroughputControlStore throughputControlStore) {
        this.replicatedResourceClient.enableThroughputBudgetControl(throughputControlStore);
    }
